...
function randomStage(job, num) { // might want to edit to prevent stages from having the same index on the same job, right now that is statistically impropable
    ...
    panelContent = [{"title":"Interviewer Instructions","templateUrl":"/js/postings/edit/pipeline/panel-templates/default-notes.html","panelId":0,"panelNotes":"<h3><b><u>Technical Interview</u></b></h3><div><b>​Instructions for Interviewers</b></div><div><b><br/></b></div><div><b>Please ask the Longest Palindromic Substring question: Write a function that finds the longest palindromic substring given a string.</b></div><div><b><br/></b></div><div><b>This interview is an assessment of the candidate's technical ability. You'll want to spend the majority of the time on the pair programming question. </b></div><div><b><br/></b></div><div><b>Tips</b></div><div><ul><li><b>Don't get too bogged down in the details -- make sure that the candidate has enough time to finish it out. </b></li><li><b>Leave 5 min at the end of the interview for any questions that come to mind!</b><br/></li></ul></div><div><b><br/></b></div><div><b>Here's a general outline of how to conduct this 30 min interview:</b></div><div><b><br/></b></div><div><ol><li><b>Introduction (3 min) - Where do you currently work? What do you do there?</b></li><li><b>Previous work experience (3 min) - What other jobs have you had?</b></li><li><b>Pair programming challenge (19 min) - Longest Palindromic Substring</b></li><li><b>Questions from the candidate (5 min)</b></li></ol></div>"},{"title":"Interview Kit","templateUrl":"/js/postings/edit/pipeline/panel-templates/default-form.html","panelId":1,"panelQuestions":[{"title":"Rating","description":"This is the overall score of the candidate.","selectedField":"dropdown","dropdownOptions":"","options":[{"value":"4 - Strong Hire"},{"id":"choice2","value":"3 - Hire"},{"id":"choice3","value":"2 - No Hire"},{"id":"choice4","value":"1 - Strong No Hire"},{"id":"choice5"}]},{"title":"How awesome is this candidate compared to other engineers?","description":"Compare to other interview candidates.","selectedField":"radio","options":[{"value":"Top 1%"},{"id":"choice2","value":"Top 10%"},{"id":"choice3","value":"Top 25%"},{"id":"choice4","value":"Below top 25%"},{"id":"choice5"}]},{"title":"Engineering Scorecard","description":"Rate candidate based on their code style, analytical thinking, and communication skills.","selectedField":"scoreboard","dropdownOptions":"","options":[{"value":"Does this candidate meet our bar for algorithm problems?"},{"id":"choice2","value":"Is the code clean? Does it have good structure?"},{"id":"choice3","value":"Can we trust this candidate with our challenges?"},{"id":"choice4","value":"Are they able to articulate the details?"},{"id":"choice5"}]},{"title":"Longest Palindromic Substring","description":"Please include the code that the candidate wrote to answer this question.","selectedField":"code"},{"title":"Would you enjoy working alongside this individual?","description":"Your opinion.","selectedField":"yesno"},{"title":"Describe candidate in one adjective.","description":"Based on the entire interview.","selectedField":"textbox"},{"title":"Additional Thoughts?","description":"Anything else that came to your mind about the candidate during the interview process.","selectedField":"textbox"}]}]
} else if (num === 2) {
     panelContent = [{"title":"Interviewer Instructions","templateUrl":"/js/postings/edit/pipeline/panel-templates/default-notes.html","panelId":0,"panelNotes":"<ol><li>Print out interview questions.</li><li>Ask about previous experience as a lead developer.</li></ol>"},{"title":"Interview Kit","templateUrl":"/js/postings/edit/pipeline/panel-templates/default-form.html","panelId":1,"panelQuestions":[{"title":"Describe candidate in a single word.","description":"Adjectives only.","selectedField":"text","dropdownOptions":""},{"title":"What did the candidate do well?","description":"Note their behavior.","selectedField":"textbox"},{"title":"Programming Portion","description":"Include the programming code sample from HackerRank.","selectedField":"code","dropdownOptions":""}]}];
    } else if (num === 3) {
